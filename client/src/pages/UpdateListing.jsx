    ...
    <main className="p-3 max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        <div className="flex flex-col gap-4 flex-1">
          <label className="input input-bordered flex items-center gap-2 border border-red-400">
            Name
            <input
              type="text"
              id="name"
            ...
            formData.imageUrls.map((url, i) => (
              <div className=" flex justify-between" key={i}>
                <img
                  src={url}
                  alt="listing"
                  className=" sm:size-40 size-28 object-cover rounded-md"
                />
                <button
                  className=" "
                  type="button"
                ...
                >
                  <TiDeleteOutline className=" size-9 text-red-700" />
                </button>
              </div>
            ))}
          <button
